...
const units = {
  ...
  Pressure: { Pa: 1, kPa: 1e3, MPa: 1e6, GPa: 1e9,
...
/* ===============================
   Converter Module
   - 범위를 DOMContentLoaded로 제한하여
     calculator input과 충돌 방지
================================ */
document.addEventListener("DOMContentLoaded", () => {

  // DOM Elements (converter 전용)
  ...
  // Enter 키 이벤트 (converter input에서만)
